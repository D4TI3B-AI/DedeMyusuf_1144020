import sys
print("Langkah Benar 3-4-5-6-7-3-4-5-8\n")
print (" 1.Petani Menyebrang\n 2.Petani Kembali\n 3.Ayam Menyeberang\n 4.Ayam Kembali\n 5.Gabah Menyebrang\n 6.Gabah Kembali\n 7.Harimau Menyebrang\n 8.Harimau Kembali")
def game():
    print('Posisi Kiri : (p,a,g,h) (1,1,1,1)\nPosisi Kanan : (p,a,g,h) (0,0,0,0)')
    a = input("Langkah 1 : ")
    if a == '3'    : b = input("Posisi Kiri : (p,a,g,h) (0,0,1,1)\nPosisi Kanan : (p,a,g,h) (1,1,0,0)\n Langkah 2 : ")
    else           : print('Game Over')
    if b == '4'    : c = input("Posisi Kiri : (p,a,g,h) (1,0,1,1)\nPosisi Kanan : (p,a,g,h) (0,1,0,0)\nLangkah 3 : ")
    else           : print('Game Over')
    if c == '5'    : d = input("Posisi Kiri : (p,a,g,h) (0,0,1,0)\nPosisi Kanan : (p,a,g,h) (1,1,0,1)\nLangkah 4 : ")
    else           : print('Game Over')
    if d == '6'    : e = input("Posisi Kiri : (p,a,g,h) (1,1,1,0)\nPosisi Kanan : (p,a,g,h) (0,0,0,1)\nLangkah 5 : ")
    else           : print('Game Over')
    if e == '7'    : f = input("Posisi Kiri : (p,a,g,h) (0,1,0,0)\nPosisi Kanan : (p,a,g,h) (1,0,1,1)\nLangkah 6 : ")
    else           : print('Game Over')
    if f == '3'    : g = input("Posisi Kiri : (p,a,g,h) (1,1,0,0)\nPosisi Kanan : (p,a,g,h) (0,0,1,1)\nLangkah 7 : ")
    else           : print('Game Over')
